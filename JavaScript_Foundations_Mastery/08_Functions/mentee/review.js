...
let makeFullName = (first, last) => {
    return first + last;
}
console.log(makeFullName("Mario ", "Bros"));
...
let formatPrice = (priceNumber) => {
    return `$${priceNumber.toFixed(2)}`;
}

console.log(formatPrice(9));
console.log(formatPrice(39.4334));
console.log(formatPrice(13.267));
