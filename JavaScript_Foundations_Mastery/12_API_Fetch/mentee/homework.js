...
searchCountryBtn.addEventListener("click", () => {
    ...
    .then ((data) => {
        ...
        const name = countryInfoData.name.common;
        // const capital = countryInfoData.capital[0];
        const capital = countryInfoData.capital ? countryInfoData.capital[0] : "No capital listed";
        const region = countryInfoData.region;
        const population = countryInfoData.population;
        ...
        countryPopulationDisplay.textContent = "Population: " + population.toLocaleString();
